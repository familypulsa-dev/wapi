...
func NewRemoveReactionMessage(to, messageID string, emoji string) *Message {
	return &Message{
		MessagingProduct: "whatsapp",
		To:               to,
		Type:             "reaction",
...
// NewTypingIndicator creates a "typing" status update.
// WhatsApp API: { "messaging_product": "whatsapp", "status": "read" }
func NewTypingIndicator(messageID string) *Message {
	return &Message{
		MessagingProduct: "whatsapp",
		Status:           "read",
		MessageID:        messageID,
